...
$sql = "SELECT *, COUNT(*) AS total_posts
        FROM login
        LEFT JOIN upload_image ON upload_image.login_id = login.id
        GROUP BY login.id";
...
// this code for count total number of user
...
// total iamge uploaded count
$stmt = $conn->prepare('SELECT COUNT(*) FROM upload_image');
$stmt->execute();
                ...
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                      ...
                      <th class="px-4 py-3">Total Post</th>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold"><?php echo $result['name']; ?></p>
